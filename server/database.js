...
const plantTable = 'CREATE TABLE IF NOT EXISTS Plants (pid INTEGER PRIMARY KEY AUTOINCREMENT, gid INTEGER NOT NULL, name TEXT NOT NULL, picture TEXT, birth TEXT, death TEXT, FOREIGN KEY(gid) REFERENCES Gardens(gid) ON DELETE CASCADE)'
