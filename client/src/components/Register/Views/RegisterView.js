    ...
    return (
        <div className="Register2">
            ...
            <div>
                ...
                <Alert id="httpwarning" variant="danger">Don't enter sensitive data in this form (or on this site) if there is no secure HTTPS connection. <a href="https://support.google.com/webmasters/answer/6073543" rel="noopener noreferrer" target="_blank">Learn more!</a></Alert>
                <form>
                <table>
                    <tbody>
                        <tr>
